...
const AkhterSaeed = () => {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      try {
        ...
        const filteredDepartments = allDepartments.filter(department => department.id >= 1 && department.id <= 18);
  ...
  .behria_inclave_header_image {
    background: linear-gradient(180deg, rgba(40, 76, 170, 0.74) 0%, rgba(3, 5, 29, 0.64) 100%), 
                url("/akhtersaeed.jpg") no-repeat center center;
        ...
        <div className="row">
          <div className="col-12 behria_inclave_header_image d-flex flex-column align-items-center justify-content-center">
            ...
            <div className='z-1 text-center d-flex flex-column align-items-center' style={{ marginTop: "8rem", '@media (min-width: 576px)': { marginTop: "0.25rem" } }} >'
              <h2 className='fw-bold text-white fs-1' data-aos="fade-up">Akhter Saeed Branch</h2>
              <p className='text-white fs-5' data-aos="fade-up" style={{ maxWidth: "55rem" }}>
                The Akhter Saeed Branch of Farooq Hospital is dedicated to providing exceptional medical care and services, ensuring the health and well-being of its community.
              </p>
              {/* Buttons Section */}
