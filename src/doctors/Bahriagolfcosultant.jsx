...
const Bahriagolfcosultant = () => {
  ...
  return (
    <>
      <style jsx>{`
        .bahriagolf_header_image {
          background: linear-gradient(180deg, rgba(40, 76, 170, 0.74) 0%, rgba(3, 5, 29, 0.64) 100%), 
          url("/bahriagolfconsultant.jpg") no-repeat center center;
          background-size: cover;
          height: 80vh;
          position: relative;
          z-index: 1;
        }
        .bahriagolf_header_image::after {
          content: "";
          position: absolute;
          top: 0;
          left: 0;
      ...
      <div className="container-fluid position-relative">
        <div className="row">
          <div className="col-12 bahriagolf_header_image d-flex flex-column align-items-center justify-content-center">
            {/* Text Section */}
            <div className='z-1 text-center d-flex flex-column align-items-center' style={{ marginTop: "8rem", '@media (min-width: 576px)': { marginTop: "0.25rem" } }}>
              <h1 className='fw-bold text-white fs-1' data-aos="fade-up">Bahria Golf Consultant Branch</h1>
              <p className='text-white fs-5' data-aos="fade-up" style={{ maxWidth: "55rem" }}>
                The Bahria Golf Consultant Branch of Farooq Hospital is dedicated to providing expert consultation services, backed by a team of highly qualified professionals.
              </p>
              {/* Buttons Section */}
...
export default Bahriagolfcosultant;
