  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        ...
        setEvents(allEvents.slice(0, 7)); // Get only the first 7 events
      } catch (error) {
    ...
    <>
      <style jsx>{`
        .westwood_header_image {
          ...
          url("/westwoodconsultant.jpg") no-repeat center center;
        ...
        <div className="row">
          <div className="col-12 westwood_header_image d-flex flex-column align-items-center justify-content-center">
            ...
            <div className='z-1 text-center d-flex flex-column align-items-center' style={{ marginTop: "8rem", '@media (min-width: 576px)': { marginTop: "0.25rem" } }}>
              <h1 className='fw-bold text-white fs-1' data-aos="fade-up">Westwood Consultant Branch</h1>
              <p className='text-white fs-5' data-aos="fade-up" style={{ maxWidth: "55rem" }}>
                The Westwood Consultant Branch of Farooq Hospital is dedicated to providing expert consultation services, backed by a team of highly qualified professionals.
              </p>
              {/* Buttons Section */}
...
export default Westwoodconsultant;
