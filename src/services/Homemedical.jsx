...
import HomemedicalServices from '../components/HomemedicalServices.jsx';
      ...
      <style jsx>{`
        .homemedical_header_image {
          background: linear-gradient(180deg, rgba(40, 76, 170, 0.74) 0%, rgba(3, 5, 29, 0.64) 100%), 
                      url("/homemedical.jpg") no-repeat center center;
        ...
        <div className="row">
          <div className="col-12 homemedical_header_image d-flex flex-column align-items-center justify-content-center">
            ...
            <div className='z-1 text-center d-flex flex-column align-items-center' style={{ marginTop: "8rem" }}>
              <h2 className='fw-bold text-white fs-1' data-aos="fade-up">Home Medical Services</h2>
              <p className='text-white fs-5' data-aos="fade-up" style={{ maxWidth: "55rem" }}>
                Our Home Medical Services provide top-notch healthcare solutions right at your doorstep, ensuring the best medical care and support in the comfort of your home.
              </p>
              {/* Buttons Section */}
